...
namespace QueryBuilder
{
	public class QueryBuilder : IDisposable
	{
        ...
        // TODO: Add the Create method                                                                                      ITS RIGHT HERE THE CREATE METHOD IS HERE ITS HERE ITS HERE
        public void Create<T>(T obj) where T : IClassModel
        {
            ...
            foreach (var property in properties)
            {
                ...
                if (property.PropertyType == typeof(DateTime))
                {
                    ...
                    values.Add($"\"{((DateTime)property.GetValue(obj)).ToString("yyyy-MM-dd")}\"");
                }
            ...
            sb.Append($"INSERT INTO {typeof(T).Name} ({string.Join(", ", names)}) VALUES ({string.Join(", ", values)})");
